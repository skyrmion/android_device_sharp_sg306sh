...
#define LIS2DH_IOCTL_BASE		71
#define LIS2DH_IOCTL_SET_DELAY		_IOW(LIS2DH_IOCTL_BASE, 0, int)
#define LIS2DH_IOCTL_GET_DELAY		_IOR(LIS2DH_IOCTL_BASE, 1, int)
#define LIS2DH_IOCTL_SET_ENABLE		_IOW(LIS2DH_IOCTL_BASE, 2, int)
#define LIS2DH_IOCTL_GET_ENABLE		_IOR(LIS2DH_IOCTL_BASE, 3, int)
