...
static struct sensor_t sSensorList[] = {
    {
        .name = "LIS2DH 3-axis Accelerometer",
        .vendor = "ST Micro",
        .version = 1,
        .handle = SENSORS_ACCELERATION_HANDLE,
        .type = SENSOR_TYPE_ACCELEROMETER,
        .maxRange = 39.2400016784668,
        .resolution = 0.009810000658035278,
        .power = 0.25,
        .minDelay = 10000,
...
#ifdef WITH_GYROSCOPE
    {
        ...
        .maxRange = 2000.0 * DEG_TO_RAD,
        .resolution = 0.07 * DEG_TO_RAD,
        .power = 6.1,
        .minDelay = 10000,
        .fifoReservedEventCount = 0,
        .fifoMaxEventCount = 0,
